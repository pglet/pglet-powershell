...
$msg = "Watch out! You've been warned!"

Invoke-Pglet "add
  message value='This is just a message.'
  message type=info value='Congratulations, you\'ve got a star!' icon=FavoriteStar iconColor=Orange dismiss dismissIcon=Like dismissIconColor='salmon'
  ...
  message type=SevereWarning dismiss value=`"$msg`"
